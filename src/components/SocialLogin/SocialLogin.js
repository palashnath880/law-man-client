...
const SocialLogin = () => {
    ...
    return (
        <div className='flex gap-2'>
            <button onClick={googleSignInHandler} type='button' className='flex gap-2 items-center border w-full py-3 px-3 justify-center rounded-md text-sm hover:bg-slate-100 duration-300 '>
