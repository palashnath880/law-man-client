        ...
        <div className='h-screen w-full' style={{ backgroundImage: `linear-gradient(#00000050, #00000050),url(${bgImg})` }}>
            <div className='h-full w-full flex justify-center items-center'>
                <div className='text-center'>
                    ...
                    <Link className='uppercase border bg-slate-50 hover:bg-transparent text-gray-700 hover:text-slate-50 font-semibold inline-block duration-300 hover:tracking-wide px-8 py-2'>Get Started</Link>
                </div>
            </div>
        </div>
    );
